...
test("listOutPeople function prints a list of the best people in FAC", function(t){
  ...
  console.log(html);
  t.ok(html.indexOf("<li>Dan Sofer</li> <li>Ines Teles</li> <li>Nelson Correira</li>") > -1, "YAY! thats correct!");
  t.end()
})
...
test("getInContact function prints FAC's contact details", function(t){
  ...
  console.log(html);
  t.ok(html.indexOf("Please email hello@foundersandcoders.com if you want to get in touch!") > -1, "Congrats! You printed out the email!");
  t.end();
})
